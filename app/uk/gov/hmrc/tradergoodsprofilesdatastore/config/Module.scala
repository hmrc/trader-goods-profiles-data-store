...
import uk.gov.hmrc.tradergoodsprofilesdatastore.worker.{ClearCacheWorker, SdesSubmissionWorker, StaleDownloadWorker}
...
class Module extends AbstractModule {
  ...
  override def configure(): Unit = {
    ...
    bind(classOf[SdesSubmissionWorker]).asEagerSingleton()
    bind(classOf[StaleDownloadWorker]).asEagerSingleton()
  }
}
